...
urlpatterns = [
    ...
    path('perfil/mudar_senha/submit', submit_mudar_senha_esqueci, name='submit_mudar_senha_esqueci'),
    path('login/mudar_senha/submit', submit_mudar_senha, name='submit_mudar_senha_esqueci'),
